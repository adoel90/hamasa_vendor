module.exports = function(req, res, next){
   res.render('masterTemplate', {
      page:{
         ...
         params: req.params,
         data: {
   				controller: '/dist/js/controller/purchasing/supplierController.js',
   				...
   				service: ['/dist/js/services/modal.js', '/dist/js/services/landing.js', '/dist/js/services/cookies.js', '/dist/js/services/user.js', '/dist/js/services/supplier.js']
   			}
      }
   })
}
