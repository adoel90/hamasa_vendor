module.exports = function(req, res, next){
   res.render('amandemenPurchasingContract', {
      page:{
         title: 'Amandemen Kontrak Pembelian',
         controllerName: 'amandemenPurchasingContractController',
         route: req.route.path,
         params: req.params,
         data: {
   				controller: '/dist/js/controller/purchasing/amandemenPurchasingContractController.js',
