module.exports = function(req, res, next){
  res.render('salesOrderAuthEdit', {
		page: {
			title: 'Otorisasi Sales Order',
			controllerName: 'salesOrderAuthController',
			route: req.route.path,
      params: req.params,
      data: {
        controller: '/dist/js/controller/authorization/salesOrderAuthController.js',
