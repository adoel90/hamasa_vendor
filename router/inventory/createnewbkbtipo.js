module.exports = function(req, res, next){
	res.render('createNewBkbTipo', {
		page: {
			title: 'Buat BKB Tipo Baru',
			controllerName: 'createNewBkbTipoController',
			route: req.route.path,
			params: req.params,
			data: {
				controller: '/dist/js/controller/inventory/createNewBkbTipoController.js',
