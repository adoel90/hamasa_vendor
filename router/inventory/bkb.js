module.exports = function(req, res, next){
    res.render('masterTemplate2', {
        page: {
            ...
            controllerName: 'bkbController',
            route: req.route.path,
            params: req.params,
            data: {
              controller: '/dist/js/controller/inventory/bkbController.js',
              ...
              service: ['/dist/js/services/modal.js', '/dist/js/services/landing.js', '/dist/js/services/cookies.js', '/dist/js/services/user.js', '/dist/js/services/bkb.js']
            }
        }
    });
}
