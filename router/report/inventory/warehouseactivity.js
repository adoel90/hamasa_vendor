module.exports = function(req, res, next){
   res.render('warehouseReporting', {
      page:{
         title: 'Laporan Aktivitas Gudang',
         controllerName: 'warehouseActivityReportController',
         route: req.route.path,
         params: req.params,
         data: {
           controller: '/dist/js/controller/report/inventory/warehouseActivityReportController.js',
