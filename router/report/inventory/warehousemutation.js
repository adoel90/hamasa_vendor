module.exports = function(req, res, next){
    res.render('warehouseMutationReport', {
       page:{
          title: 'Laporan Mutasi Gudang',
          controllerName: 'warehouseMutationReportController',
          route: req.route.path,
          params: req.params,
          data: {
            controller: '/dist/js/controller/report/inventory/warehouseMutationReportController.js',
