module.exports = function(req, res, next){
   res.render('purchasingModuleReport', {
      page:{
         title: 'Reporting Modul Pembelian',
         controllerName: 'purchasingModuleReportController',
         route: req.route.path,
         params: req.params,
         data: {
           controller: '/dist/js/controller/report/purchasing/purchasingModuleReportController.js',
