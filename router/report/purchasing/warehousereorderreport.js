module.exports = function(req, res, next){
   res.render('warehouseReorderReport', {
      page:{
         title: 'Reporting Reorder Gudang',
         controllerName: 'warehouseReorderReportController',
         route: req.route.path,
         params: req.params,
         data: {
           controller: '/dist/js/controller/report/purchasing/warehouseReorderReportController.js',
