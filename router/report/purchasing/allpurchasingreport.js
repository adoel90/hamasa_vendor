module.exports = function(req, res, next){
    res.render('allPurchasingReport', {
       page:{
          title: 'Laporan Seluruh Pembelian',
          controllerName: 'allPurchasingReportController',
          route: req.route.path,
          params: req.params,
          data: {
            controller: '/dist/js/controller/report/purchasing/allPurchasingReportController.js',
