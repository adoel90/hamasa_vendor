module.exports = function(req, res, next){
   res.render('purchasingContractReport', {
      page:{
         title: 'Reporting Kontrak Pembelian',
         controllerName: 'purchasingContractReportController',
         route: req.route.path,
         params: req.params,
         data: {
           controller: '/dist/js/controller/report/purchasing/purchasingContractReportController.js',
