module.exports = function(req, res, next){
    res.render('itemSoldReport', {
       page:{
          title: 'Report Stok Item Terjual',
          controllerName: 'itemSoldReportController',
          route: req.route.path,
          params: req.params,
          data: {
            controller: '/dist/js/controller/report/sales/itemSoldReportController.js',
