module.exports = function(req, res, next){
    res.render('accountReceivableReport', {
       page:{
          title: 'Laporan Piutang',
          controllerName: 'accountReceivableReportController',
          route: req.route.path,
          params: req.params,
          data: {
            controller: '/dist/js/controller/report/sales/accountReceivableReportController.js',
