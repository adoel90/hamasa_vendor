module.exports = function(req, res, next){
   res.render('reportTemplateByStartEndDate', {
      page:{
         title: 'Laporan Analisa Piutang Customer',
         controllerName: 'customerCreditAnalysisReportController',
         route: req.route.path,
         params: req.params,
         data: {
           controller: '/dist/js/controller/report/finance/customerCreditAnalysisReportController.js',
