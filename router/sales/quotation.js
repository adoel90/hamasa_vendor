module.exports = function(req, res, next){
	res.render('masterTemplate2', {
		page : {
			...
			params: req.params,
			data: {
				controller: '/dist/js/controller/sales/quotationController.js',
				...
				service: ['/dist/js/services/modal.js', '/dist/js/services/landing.js', '/dist/js/services/cookies.js', '/dist/js/services/user.js', '/dist/js/services/quotation.js']
			}
		}
	})
}
